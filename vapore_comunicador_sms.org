...
** TODO Modificacion Soft, para reportar a un numero especial las activaciones
** TODO Modificacion Hard, se cambia la entrada de sensado de 4V para tomar la activacion
